...
unlocked to sign the Compass-Qt.app bundle.
...
allowing somebody to distribute a Compass-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the compass-qt.exe file inside the installer had not been tampered with.
